    ...
    TypeMap_PushContained(&s->types,funcs,
        Type_New("small",8,OperatorInterationMap_Make((OperatorInterater[]){
            OperatorInterater_Make((CStr[]){ NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_LUALIKE_NEG,Small_Small_Handler_Neg),
                OperatorDefiner_New(TOKEN_CAST,Small_Handler_Cast),
                OperatorDefiner_New(TOKEN_INIT,NULL),
                OperatorDefiner_New(TOKEN_DESTROY,NULL),
                OPERATORDEFINER_END
            })),
            OperatorInterater_Make((CStr[]){ "small",NULL },OperatorDefineMap_Make((OperatorDefiner[]){
                OperatorDefiner_New(TOKEN_LUALIKE_ASS,Small_Small_Handler_Ass),
                OperatorDefiner_New(TOKEN_LUALIKE_ADD,Small_Small_Handler_Add),
                OperatorDefiner_New(TOKEN_LUALIKE_SUB,Small_Small_Handler_Sub),
                OperatorDefiner_New(TOKEN_LUALIKE_MUL,Small_Small_Handler_Mul),
                OperatorDefiner_New(TOKEN_LUALIKE_DIV,Small_Small_Handler_Div),
                OperatorDefiner_New(TOKEN_LUALIKE_EQU,Small_Small_Handler_Equ),
                OperatorDefiner_New(TOKEN_LUALIKE_LES,Small_Small_Handler_Les),
                OperatorDefiner_New(TOKEN_LUALIKE_GRT,Small_Small_Handler_Grt),
                OperatorDefiner_New(TOKEN_LUALIKE_LEQ,Small_Small_Handler_Leq),
                OperatorDefiner_New(TOKEN_LUALIKE_GRQ,Small_Small_Handler_Grq),
                OPERATORDEFINER_END
            })),
